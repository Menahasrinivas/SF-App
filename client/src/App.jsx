...
const handleSubmit = async (e) =>{
  e.preventDefault();
  if (userData.id) {
    await axios.patch(`http://localhost:8000/users/$
      {userData.id}`, userData).then((res)=> {
        console.log(res);
      });
   } else {
      ...
      <div className="container">
        ...
        <table className="table">
          ...
          <tbody>
            ...
            <td><button 
            className="btn green" onClick={()=>handleUpdateRecord(user.id)}>Edit
            </button></td>
